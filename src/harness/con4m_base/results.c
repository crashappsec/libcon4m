...
show_gridview(void)
{
    c4m_grid_t *success_grid = c4m_new(
        c4m_type_grid(),
        c4m_kw("start_cols",
               c4m_ka(2),
               "header_rows",
    ...
    c4m_set_column_style(success_grid, 0, c4m_new_utf8("full_snap"));
    c4m_set_column_style(success_grid, 1, c4m_new_utf8("snap"));
    c4m_set_column_style(fail_grid, 0, c4m_new_utf8("full_snap"));
    c4m_set_column_style(fail_grid, 1, c4m_new_utf8("snap"));
