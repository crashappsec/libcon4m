...
#define c4m_tpat_find(x, y, ...)  _c4m_tpat_find(x, y, C4M_VA(__VA_ARGS__))
#define c4m_tpat_match(x, y, ...) _c4m_tpat_match(x, y, C4M_VA(__VA_ARGS__))
#define c4m_tpat_opt_match(x, y, ...) \
    _c4m_tpat_opt_match(x, y, C4M_VA(__VA_ARGS__))
#define c4m_tpat_n_m_match(a, b, c, d, ...) \
    _c4m_tpat_n_m_match(a, b, c, d, C4M_VA(__VA_ARGS__))
